"""
A simple command-line interface (CLI) to download YouTube playlists.
"""
import os
import sys
import time
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("playlist_downloader.log", encoding="utf-8"),
...
def main():
    ...
    # Download playlist
    download_playlist(playlist_link, download_path, resolution=res, audio_only=audio)
